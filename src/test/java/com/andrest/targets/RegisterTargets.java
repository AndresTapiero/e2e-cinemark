...
public class RegisterTargets {
    ...
    public static Target EMAIL_INPUT = Target.the("Email input").located(AppiumBy.xpath("//android.view.View[2]/android.widget.ScrollView/android.widget.EditText[3]"));
    ...
    public static Target PASSWORD_INPUT = Target.the("Password input").located(AppiumBy.xpath("//android.view.View[2]/android.widget.ScrollView/android.widget.EditText[6]"));
